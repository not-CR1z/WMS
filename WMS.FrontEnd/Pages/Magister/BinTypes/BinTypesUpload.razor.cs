...
{
    public partial class BinTypesUpload
    {
        ...
        private async Task UploadAsycn()
        {
            ...
            loading = true;
            var httpResponse = await Repository.PostAsync<List<BinType>,ActionResponse<List<BinType>>>("/api/bintypes/uploadasync", MyList);
            loading = false;

            var response = (ActionResponse<List<BinType>>)httpResponse.Response!;
            ...
            MyList = (List<BinType>)response.Result!;            
        }
