...
{
    [Authorize]
    public partial class ProductClassificationDetailsClock
    {
        [EditorRequired, Parameter] public long Id { get; set; }
        private ProductClassificationDetail? model;
        ...
        {
            loading = true;
            var responseHttp = await Repository.GetAsync<ProductClassificationDetail>($"/api/productclassificationdetails/{Id}");
            loading = false;
