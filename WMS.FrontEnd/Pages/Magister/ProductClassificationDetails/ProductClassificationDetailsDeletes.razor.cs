...
{
    public partial class ProductClassificationDetailsDeletes
    {
        ...
        {
            var url = $"api/productclassificationdetails/getdeleteasync?page={page}";
        ...
        {
            var url = $"api/productclassificationdetails/deletetotalPages";
            if (!string.IsNullOrEmpty(Filter))
            {
                url += $"?filter={Filter}";
            }
        ...
        private async Task RestoreAsycn(ProductClassificationDetail model)
        {
            ...
            if (responseHttp.Error)
            {
                ...
                {
                    NavigationManager.NavigateTo("/productclassificationdetails/deletes");
                }
                else
                {
